...
describe('routeByKeyword', () => {
  ...
  it('routes test-writing prompts to TestAgent', () => {
    assert.equal(routeByKeyword('Write pytest tests for this Alice auth helper'), 'TestAgent');
  ...
  it('routes documentation prompts to DocAgent', () => {
    assert.equal(routeByKeyword('Document how to rotate the Alice admin password'), 'DocAgent');
  ...
  it('routes slide prompts to SlideAgent', () => {
    assert.equal(routeByKeyword('Build a five-slide presentation deck for a Alice client demo'), 'SlideAgent');
  ...
  it('routes video script prompts to VideoScriptAgent', () => {
    assert.equal(routeByKeyword('Write a 90-second video script explaining Alice'), 'VideoScriptAgent');
  ...
  it('routes health prompts to HealthAgent', () => {
    assert.equal(routeByKeyword('Interpret this systemctl status output for alice-web'), 'HealthAgent');
  });
