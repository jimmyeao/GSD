export const AGENTS = [
  ...
  },
  {
    ...
    example: 'Diagram the GSD request flow from browser to model.',
    icon: '📐',
    model: 'General LLM',
  },
  {
    ...
    example: 'Document how to rotate the GSD admin password.',
    icon: '📝',
    model: 'General LLM',
  },
  {
  ...
  },
  {
    ...
    example: 'Interpret this systemctl status output for gsd-web.',
    icon: '🩺',
    model: 'General LLM',
  },
  {
  ...
  },
  {
    ...
    example: 'Build a five-slide intro deck for a GSD client demo.',
    icon: '📊',
    model: 'General LLM',
  },
  {
    ...
    example: 'Write pytest tests for this GSD auth helper.',
    icon: '🧪',
    model: 'Qwen3-Coder 80B',
  },
  {
  ...
  },
  {
    ...
    example: 'Write a 90-second video script explaining GSD.',
    icon: '🎥',
    model: 'General LLM',
  },
];
